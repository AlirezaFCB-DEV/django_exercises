...
def create_question(question_txt, days):
    """
        Create a question with given `question_txt` and published the given number
        of `days` offset to now (negative for questions published in the past , positive for questions
        that have yet to be published).
    """

    time = timezone.now() + datetime.timedelta(days=days)
    return Question.objects.create(question_text=question_txt, pub_date=time)
...
class Question_Index_View_Tests(TestCase):
    ...
    def test_past_question(self):
        ...
        self.assertQuerySetEqual(
            res.context["latest_question_list"], [question])
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = create_question(question_txt="Past question1.", days=-30)
        question2 = create_question(question_txt="Past question2.", days=-5)
...
class Question_Detail_View_Tests(TestCase):
    def test_future_question(self):
        ...
        future_question = create_question(question_txt="Future question." , days=1999)
    ...
    def test_pass_question(self):
        ...
        past_question = create_question(
            question_txt="Past question.", days=-20)
